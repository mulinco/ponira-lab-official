...
>
  ...
  <div className="flex items-center justify-between mb-6 pb-3 border-b border-white/10">
    ...
    <div className="flex items-center gap-1.5 bg-white/5 border border-white/10 rounded-md px-2 py-1">
      <span className="text-ponira-white/30 text-[9px]">🔒</span>
  ...
  <div className="flex items-center justify-between mb-6">
    ...
    <div className="flex gap-3">
      {["Work", "About", "Contact"].map((item) => (
        <span key={item} className="text-ponira-white/20 font-body text-[9px] uppercase tracking-wider">
          {item}
        </span>
      ))}
    </div>
  ...
  {/* CTA */}
  <div className="mt-4 flex items-center justify-between pr-4"> {/* pr-4 extra no bottom-left */}
