        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 items-start">
          ...
          <div>
            ...
            <ul className="text-ponira-white/50 font-body text-[10px] space-y-2 uppercase tracking-tighter">
              <li><a href="#" className="hover:text-ponira-yellow transition-colors">Instagram</a></li>
              <li><a href="#" className="hover:text-ponira-yellow transition-colors">LinkedIn</a></li>
              <li><a href="#" className="hover:text-ponira-yellow transition-colors">GitHub</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="text-ponira-white/50 font-body text-[10px] space-y-2 italic">
              <li><a href="https://creative.poniralab.com" className="hover:text-ponira-yellow transition-colors">Creative</a></li>
              <li><a href="https://studio.poniralab.com" className="hover:text-ponira-yellow transition-colors">Studio</a></li>
              <li><a href="https://systems.poniralab.com" className="hover:text-ponira-yellow transition-colors">Systems</a></li>
            </ul>
          </div>
