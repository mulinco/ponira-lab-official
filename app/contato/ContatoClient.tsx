            ...
            >
              {status === "success" ? (
                ...
                >
                  ...
                  <h2 className="text-3xl font-display italic text-ponira-white">Mensagem recebida.</h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <Field label="Nome" name="nome" type="text" placeholder="Seu nome" value={form.nome} onChange={handleChange} required />
                    <Field label="Email" name="email" type="email" placeholder="seu@email.com" value={form.email} onChange={handleChange} required />
                  </div>
                  <Field label="WhatsApp (opcional)" name="whatsapp" type="tel" placeholder="(21) 99999-9999" value={form.whatsapp} onChange={handleChange} />
                  <SelectField label="Tipo de projeto" name="tipoProjeto" options={tiposProjeto} value={form.tipoProjeto} onChange={handleChange} required />
                  <SelectField label="Orçamento estimado" name="orcamento" options={orcamentos} value={form.orcamento} onChange={handleChange} required />
            ...
            >
              <div className="p-8 border border-ponira-white/5 rounded-sm bg-black/10 space-y-5">
                <div>
                  ...
                  <h3 className="text-2xl font-display italic text-ponira-white mb-2">Chame pelo WhatsApp</h3>
